...
### Play Stream Button
Play a direct HTTP(S) audio stream (for example an internet radio URL) on a button. In the Property Inspector, select a speaker and paste the stream URL. Pressing the button starts the stream on the speaker.
